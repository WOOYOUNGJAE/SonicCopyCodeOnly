#pragma once
#include "Obj.h"
class CDiagonalSpring : public CObj
{

public:
	CDiagonalSpring();
	virtual ~CDiagonalSpring() override;

public:
	// getter
	DIAGONAL_DIR Get_SpringDir() { return m_eSpringDir; }
	int Get_SpringDirInt() { return (int)m_eSpringDir; }
	// setter
	void Set_SpringDir(DIAGONAL_DIR _eDir) { m_eSpringDir = _eDir; }
	...
	void SpringInit(DIAGONAL_DIR _eDir);
private:
	DIAGONAL_DIR m_eSpringDir;
